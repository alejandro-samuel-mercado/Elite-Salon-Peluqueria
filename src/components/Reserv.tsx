...
function ReservContent() {
  ...
  return (
    <section className="py-56 px-8 max-w-7xl mx-auto min-h-screen bg-white">
      <div className="flex flex-col lg:flex-row gap-24 items-start">
        <div className="flex-1">
          ...
          >
            ...
            <h2 className="text-8xl font-bold luxury-title italic text-black leading-[0.85] mb-12 uppercase tracking-tighter">
              AGREGA <br /> TU <span className="text-[#c5a059]">SESIÓN.</span>
            </h2>
            <p className="text-2xl text-zinc-900 font-bold italic leading-relaxed mb-16 max-w-xl">
              Selecciona tu frecuencia en nuestro nodo central de San Salvador
              de Jujuy. Confirmación inmediata vía red.
            </p>

            <div className="space-y-8">
              <div className="p-8 bg-zinc-50 rounded-[2.5rem] flex items-center gap-6 border-2 border-black">
                <MapPin
                  className="text-[#c5a059]"
                  size={32}
                  strokeWidth={2.5}
                />
                <p className="text-2xl font-black text-black luxury-title uppercase">
                  Centro, Jujuy
                </p>
              </div>
              <div className="p-8 bg-zinc-50 rounded-[2.5rem] flex items-center gap-6 border-2 border-black">
        ...
        <div className="flex-1 bg-white p-12 md:p-20 rounded-[4rem] shadow-[0_60px_120px_-20px_rgba(0,0,0,0.2)] border-2 border-black relative">
          <AnimatePresence mode="wait">
            {confirmed ? (
              ...
              >
                ...
                <h3 className="text-6xl font-black luxury-title italic text-black mb-6 uppercase leading-none">
                  ¡Turno <br /> Confirmado!
                </h3>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {services.map((s) => (
                      <button
                        ...
                        className={`p-6 border-2 flex items-center justify-between rounded-2xl transition-all ${selectedService?.includes(s.n.split(" ")[0]) ? "bg-black text-white border-black" : "bg-white border-zinc-200 text-black"}`}
                      >
