...
export default function BlogPage() {
  return (
    <div className="bg-brand-cream min-h-screen ">
      <header className="relative pt-50 pb-0 px-8 text-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-9xl md:text-[15vw] font-bold luxury-title text-brand-obsidian leading-none tracking-tighter italic mb-24 opacity-5 absolute top-20 left-1/2 -translate-x-1/2 select-none">
            DATA_LOGS
          </h1>

          <div className="relative z-10">
            <h2 className="text-8xl md:text-[10rem] font-bold luxury-title text-brand-obsidian leading-[0.8] mb-14 tracking-tighter">
              CRÓNICAS <br />{" "}
              <span className="text-brand-gold">DE ESTILO.</span>
            </h2>
            <p className="max-w-3xl mx-auto text-2xl md:text-3xl text-brand-obsidian/40 font-medium italic leading-relaxed luxury-title uppercase tracking-tighter">
      ...
      <section className="py-40 bg-white">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="relative group overflow-hidden rounded-[4rem] border border-black/5 shadow-2xl">
            <img
            ...
            <div className="absolute bottom-12 left-12">
              ...
              <p className="text-3xl text-white font-bold luxury-title italic">
          ...
          <div>
            ...
            <h3 className="text-6xl font-bold luxury-title text-brand-obsidian italic mb-10 leading-none uppercase">
            ...
            <div className="grid grid-cols-2 gap-10">
              <div className="p-8 bg-brand-cream rounded-3xl border border-black/5">
                <p className="text-4xl font-bold luxury-title text-brand-gold mb-2 italic">
                  100%
                </p>
